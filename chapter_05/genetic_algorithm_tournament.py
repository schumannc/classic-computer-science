"""
1. Add support to GeneticAlgorithm for an advanced form of 
tournament selection that may sometimes choose the second- 
or third-best chromosome, based on a diminishing probability.
"""
...
class GeneticAlgorithm(Generic[C]):
    ...
    def _pick_tournament(self, num_participants: int) -> Tuple[C, C]:
        ...
        champions = nlargest(3, participants, key=self._fitness_key)
        random_pick = choices(champions[1:], weights=[0.7, 0.3], k=1).pop()
        return (champions[0], random_pick)
